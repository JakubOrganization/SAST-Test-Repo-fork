...
public class SqlInjectionLesson7a extends AssignmentEndpoint {

    private final LessonDataSource dataSource;

    public SqlInjectionLesson7a(LessonDataSource dataSource) {
    ...
    @PostMapping("/SqlInjection/assignment5b7")
    @ResponseBody
    public AttackResult completed7(@RequestParam String userid5, @RequestParam String login_count, HttpServletRequest request) throws IOException {
        return injectableQuery1(login_count, userid5);
    }

    protected AttackResult injectableQuery1(String login_count, String accountName) {
